...
![Flat Mart Schema](/Resources/Flat_Mart.png)
...
![Skills Mart Schema](/Resources/Skills_Mart.png)
...
![Priority Mart Schema](/Resources/Priority_Mart.png)

- **SQL Files:**
  - [`05_create_priority_mart.sql`](./05_create_priority_mart.sql) – Initial build of priority roles and jobs snapshot
  - [`05,5_update_priority_roles_table.sql`](./05,5_update_priority_roles_table.sql) – Used to create, delete, or edit entries within the priority roles table
...
![Company Mart Schema](/Resources/Company_Mart.png)
...
- **Orchestration:** Master SQL script ([`build_dw_marts.sql`](./build_dw_marts.sql)) for automated pipeline execution  
