...
- ✅ **Project scope:** Built **3 analytical queries** that answer key questions about the data related job market in Indonesia
...
- 🎯 **Most in-demand:** *Which skills are most in-demand for data related fields?*  
- 💰 **Highest paid:** *Which skills command the highest salaries?*  
- ⚖️ **Best trade-off:** *What is the optimal skill set balancing demand and compensation?*  

This project analyzes a **data warehouse** built using a star schema design. The warehouse structure consists of:

![Data Warehouse Schema](/Resources/Data_Warehouse.png)
...
1. **[Top Demanded Skills](./01_top_demanded_skills.sql)** – Identifies the 20 most in-demand skills for data related positions in Indonesia
2. **[Top Paying Skills](./02_top_paying_skills.sql)** – Analyzes the 20 highest-paying skills with salary and demand metrics
...
- 🧠 Core languages: SQL and Python each appear in ~2,300 job postings, making them the most demanded skills
- ☁️ Cloud platforms: AWS and Azure are critical for modern data engineering roles
- 🧱 Infra & tooling: Kubernetes and Docker are associated with premium salaries
